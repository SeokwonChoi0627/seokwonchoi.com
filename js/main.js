...
const i18n = {
  ko: {
    ...
    html: {
      ...
      '.timeline-item:nth-child(2) .tl-desc': '그룹 모빌리티 사업(BMW·BYD) 중장기 전략 수립, 시너지 모델 검토, 경영진 의사결정 자료 작성.<br>그룹 부사장과 2인 체제로 출범한 전략본부 멤버.',
      '.timeline-item:nth-child(3) .tl-desc': '전사 예산관리 시스템(비즈플레이) 도입 주관, 월간·분기 BMW 사업보고, 중장기 10년 전략 수립 참여.<br>매출 7.6% 성장 속 판관비 절감 동시 달성, 영업이익 +17.7%(YoY) 개선에 기여. 예산 고도화 및 비용 효율화 주도.',
      '.timeline-item:nth-child(4) .tl-desc': '세무 총괄(법인세·부가세·지방세), 월결산·감사 대응, SAP 시스템 구축, 내부회계관리제도 도입,<br>정기 세무조사 3회 수검. 법인세 경정청구 50억 환급.',
  ...
  en: {
    ...
    html: {
      ...
      '.timeline-item:nth-child(2) .tl-desc': 'Led mid to long-term strategy for the Group\'s mobility business (BMW·BYD), reviewed synergy models, and prepared executive decision materials.<br>Founding member of the Strategy Division, a 2-person team with the Group EVP.',
      '.timeline-item:nth-child(3) .tl-desc': 'Spearheaded the company-wide Bizplay budget system rollout, handled monthly/quarterly BMW business reports, and participated in 10-year strategic planning.<br>Achieved SG&amp;A reduction alongside 7.6% revenue growth, contributing to a +17.7% YoY operating profit improvement.',
      '.timeline-item:nth-child(4) .tl-desc': 'Managed all taxation (corporate, VAT, local taxes), monthly closing and external audits, SAP implementation, internal accounting controls,<br>and 3 regular tax audit engagements. Led the &#8361;5B corporate tax refund claim.',
