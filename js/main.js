...
const i18n = {
  ko: {
    text: {
      ...
      '.stat-cell:nth-child(1) .stat-value sup': '년',
      '.stat-cell:nth-child(2) .stat-value sup': '억',
      '.stat-cell:nth-child(4) .stat-value sup': '회',
      '.achievement-cell:nth-child(1) .achievement-unit': '억',
      '.achievement-cell:nth-child(3) .achievement-unit': '억',
      '.achievement-cell:nth-child(5) .achievement-unit': '주',
      '.timeline-item:nth-child(6) .tl-company': '삼일회계법인 (PwC Korea)',
      '.timeline-item:nth-child(6) .tl-badge': '인턴',
      ...
      '.cap-cell:nth-child(5) .cap-domain': '자격·학력 / Credentials',
    ...
    html: {
      ...
      '.about-body p:nth-child(3)': '그룹 전략본부장(부사장)의 BYD 대표 발령으로 2인 체제였던 전략본부가 개편되는 시점에, 저는 <strong>다음 성장을 위한 능동적 전환</strong>을 선택했습니다. <strong>CFO 트랙 또는 전략기획 리더십 포지션</strong>에서 재경·기획·전략의 통합 역량을 발휘할 수 있는 환경을 찾고 있습니다. 이 페이지가 저를 이해하는 데 도움이 되기를 바랍니다.',
      ...
      '.timeline-item:nth-child(6) .timeline-period': '2015.01<br>2015.02<span class="timeline-duration">2개월</span>',
      '.timeline-item:nth-child(6) .tl-desc': '회계 감사팀 업무 보조, 조회서 발송 업무 수행.',
      '.timeline-item:nth-child(2) .tl-desc': '그룹 모빌리티 사업(BMW·BYD) 중장기 전략 수립, 시너지 모델 검토, 경영진 의사결정 자료 작성.<br>그룹 부사장과 2인 체제로 출범한 전략본부 — 본부장의 BYD 대표 발령으로 조직 개편, 이를 계기로 능동적 커리어 전환을 결심.',
      '.timeline-item:nth-child(3) .tl-desc': '전사 예산관리 시스템(비즈플레이) 도입 주관, 월간·분기 BMW 사업보고, 중장기 10년 전략 수립 참여.<br>예산 담당자로서 전사 현업 부서와의 소통 창구 역할. 매출 7.6% 성장 속 판관비 절감, 영업이익 +17.7%(YoY) 개선 — 팀 전체가 함께 이루어낸 성과.',
      '.timeline-item:nth-child(4) .tl-desc': '세무 총괄(법인세·부가세·지방세), 월결산·감사 대응, SAP 시스템 구축, 내부회계관리제도 도입,<br>정기 세무조사 3회 수검. 법인세 경정청구 50억 환급.<br>9인 재경팀 실무 총괄(2인자)로 세무·결산 전 영역 담당.',
      '.timeline-item:nth-child(5) .tl-desc': '안산복합화력발전소(자산 8,500억) 회계·세무·재무 전담. 비정기 세무조사 대응(추징 200억 → 1억 미만), 리파이낸싱(6천억) 지원.',
      '.cap-cell:nth-child(5) .cap-items': '<li>재경관리사 취득 (2014)</li><li>공인회계사 1차 응시 · 387.5점 (2013)</li><li>서강대학교 경영학과 졸업</li><li>지향: CFO 트랙 · 전략기획 리더십</li>',
  ...
  en: {
    text: {
      ...
      '.stat-cell:nth-child(1) .stat-value sup': ' yrs',
      '.stat-cell:nth-child(2) .stat-value sup': '×100M',
      '.stat-cell:nth-child(4) .stat-value sup': '×',
      '.achievement-cell:nth-child(1) .achievement-unit': '×100M',
      '.achievement-cell:nth-child(3) .achievement-unit': '×100M',
      '.achievement-cell:nth-child(5) .achievement-unit': ' wks',
      '.timeline-item:nth-child(6) .tl-company': 'Samil PricewaterhouseCoopers (PwC Korea)',
      '.timeline-item:nth-child(6) .tl-badge': 'Intern',
      ...
      '.cap-cell:nth-child(5) .cap-domain': 'Credentials',
    ...
    html: {
      ...
      '.about-body p:nth-child(3)': 'When the head of our Strategy Division (Group EVP) was appointed as CEO of BYD operations, our two-person division was restructured. I chose this as a moment for <strong>proactive career transition</strong>. I am seeking a role in a <strong>CFO track or strategic planning leadership position</strong> where I can bring together my expertise across finance, planning, and strategy. I hope this page helps you get to know me better.',
      ...
      '.timeline-item:nth-child(6) .timeline-period': '2015.01<br>2015.02<span class="timeline-duration">2 mos.</span>',
      '.timeline-item:nth-child(6) .tl-desc': 'Assisted audit team with accounting reviews; handled confirmation letter circulation for external audit procedures.',
      '.timeline-item:nth-child(2) .tl-desc': 'Led mid to long-term strategy for the Group\'s mobility business (BMW·BYD), reviewed synergy models, and prepared executive decision materials.<br>Founded the Strategy Division as a 2-person team with the Group EVP — following the EVP\'s appointment as BYD CEO, the division was restructured, prompting a proactive career transition.',
      '.timeline-item:nth-child(3) .tl-desc': 'Spearheaded the company-wide Bizplay budget system rollout, handled monthly/quarterly BMW business reports, and participated in 10-year strategic planning.<br>Served as the budget manager and key liaison between finance and business units. The +17.7% YoY operating profit improvement alongside 7.6% revenue growth was a collective achievement of the whole team.',
      '.timeline-item:nth-child(4) .tl-desc': 'Managed all taxation (corporate, VAT, local taxes), monthly closing and external audits, SAP implementation, internal accounting controls,<br>and 3 regular tax audit engagements. Led the &#8361;5B corporate tax refund claim.<br>Served as the #2 in a 9-person Finance team, overseeing all tax and closing operations.',
      ...
      '.cap-cell:nth-child(5) .cap-items': '<li>Licensed Finance Manager (2014)</li><li>CPA Part I Exam · 390 pts (2013)</li><li>B.A. Business, Sogang University</li><li>Target: CFO Track · Strategy Leadership</li>',
